...
var player = new function() {
    ...
    this.y = 550;
    this.img = new Image();
    this.img.src = "/images/doodlejump/rightPlayer.png";
    this.width = 80;
    this.height = 80;
    this.xSpeed = 6.7;
    this.ySpeed = 0;
    ...
    this.update = function() {
        if (!dead) {
            ...
            ctx.font = "20px Arial";
            ctx.fillText("Appuyez sur R pour recommencer", screenWidth / 2, (screenHeight / 2) + 50);
            if(passer){
                $.ajax({
                    url : '/games/doodle-jump/score/current/' + score,
                    type : 'GET',
                    dataType : 'json'
                })
        ...
        //Q or left-arrow key pressed
        if (holdingLeftKey) {
            this.direction = "left";
            this.img.src = "/images/doodlejump/leftPlayer.png";
            player.moveLeft();
        }
        //D or right-arrow key pressed 
        if (holdingRightKey) {
